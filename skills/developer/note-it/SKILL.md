...
| Spec/PRD file not found | Note in Open Questions: "No PRD found under the `artifacts.draftsDir` intake directory (default `.prd/`) — verify against original requirements." |

...
The router classifies the request and returns the primary agent, supporting agents, rules, role-bound skills, and whether the request must be attached to `.prd/` or a Feature-local `.features/<change-id>/` directory.

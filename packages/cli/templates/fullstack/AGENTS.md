...
1. Read human-authored drafts in `.prd/`.
2. Read stable platform and system design from `design/`.
3. Read epic, release, and dependency planning from `.features/roadmap.md`.
4. Implement from feature specs under `.features/<SPEC-ID>-<slug>/`.

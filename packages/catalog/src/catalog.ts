...
export function getWorkspaceAssetState(asset: CatalogAsset, workspaceContext?: WorkspaceAssetContext) {
  if (!workspaceContext) {
...
export function sortCatalogAssetsForWorkspace(
  assets: CatalogAsset[],
  workspaceContext?: WorkspaceAssetContext
) {

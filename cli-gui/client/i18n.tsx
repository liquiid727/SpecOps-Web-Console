...
const translations = {
  en: {
    ...
    workspaceNotFound: "The workspace is no longer available.",
    workspacePathInvalid: "The workspace path is invalid or inaccessible.",
    workspaceAlreadyRegistered: "This workspace is already registered.",
    workspaceInUse: "This workspace still has sessions.",
    ...
    gitUnavailable: "Git is unavailable in this workspace.",
  ...
  zh: {
    ...
    workspaceNotFound: "工作区已不可用。",
    workspacePathInvalid: "工作区路径无效或无法访问。",
    workspaceAlreadyRegistered: "该工作区已经登记。",
    workspaceInUse: "该工作区仍有会话。",

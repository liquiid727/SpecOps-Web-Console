...
cli-gui/doc/qoder-ui/reference/qoder-replica-prd.md  → 产品需求
cli-gui/doc/qoder-ui/spec-cli-gui-qoder-ui.md   → 技术规格
cli-gui/doc/qoder-ui/issues-cli-gui-qoder-ui.md → 10个可执行Issue
cli-gui/doc/qoder-ui/prompt-full-implementation.md → 详细实现参考（代码示例）
```

## 设计参考（交互原型）

```
cli-gui/doc/qoder-ui/reference/qoder-quest-replica.html   → Qoder Light 交互原型
cli-gui/doc/qoder-ui/reference/workbuddy-ide.html         → 深色 IDE 参考
```

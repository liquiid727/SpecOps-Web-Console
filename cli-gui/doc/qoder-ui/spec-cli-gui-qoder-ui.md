...
> Technical specification derived from: `cli-gui/doc/qoder-ui/reference/qoder-replica-prd.md` + `cli-gui/doc/mvp01/prd-cli-gui.md`
...
- **Primary PRD**: `cli-gui/doc/qoder-ui/reference/qoder-replica-prd.md` — Qoder 1:1 复刻 PRD
- **Secondary PRD**: `cli-gui/doc/mvp01/prd-cli-gui.md` — Product AI OS MVP01
- **Design References**:
  - `cli-gui/doc/qoder-ui/reference/qoder-sidebar-detail.md`
  - `cli-gui/doc/qoder-ui/reference/qoder-input-detail.md`
  - `cli-gui/doc/qoder-ui/reference/qoder-chat-detail.md`
  - `cli-gui/doc/qoder-ui/reference/qoder-right-panel-detail.md`
  - `cli-gui/doc/qoder-ui/reference/qoder-knowledge-detail.md`
  - `cli-gui/doc/qoder-ui/reference/qoder-marketplace-detail.md`
  - `cli-gui/doc/qoder-ui/reference/qoder-quest-replica.html` (interactive prototype)
  - `cli-gui/doc/qoder-ui/reference/workbuddy-ide.html` (dark theme reference)

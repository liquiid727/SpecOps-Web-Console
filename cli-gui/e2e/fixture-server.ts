...
await fs.writeFile(path.join(dataDirectory, "state.json"), JSON.stringify({
  ...
  state: {
    ...
    profiles: [{ id: "profile-fixture", name: "Fixture PTY", command: process.execPath, args: ["-e", "process.stdin.on('data', b => process.stdout.write('fixture:' + b.toString()))"], adapterId: "generic", createdAt: "2026-01-01T00:00:00Z" }],

...
- Route child Spec definition to `spec-editor` and independent testing to `testing-agent`. Precise bugs and local changes enter through `/to-issues`, independently of Test Design readiness.

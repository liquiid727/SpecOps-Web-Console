...
Owns the main architecture track for SpecOS work.
...
- Keep draft assumptions separate from accepted `design/`, `specs/roadmap.md`, and completed feature-spec facts.

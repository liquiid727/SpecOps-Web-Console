...
- Normalize concurrency output into `.requirements/results/` instead of relying on raw runner output.
...
- Concurrency scenarios under `.requirements/concurrency/<spec-id>/`

...
- Reconcile the active child Spec Package, implementation report, independent test summary, normalized gate report, and reviewer findings.
...
- Prohibited: creating Test Designs/plans/results, consuming raw output, or treating local checks as normalized evidence.

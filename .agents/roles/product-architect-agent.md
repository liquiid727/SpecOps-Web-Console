...
- Hand child Spec definition to `spec-editor` through `/prd-to-spec`. Route precise bug/local-change intake through its `/to-issues` capability. `testing-agent` owns `/spec-to-test`.

...
Use the active change package as the coordination boundary and add a generated test schedule as the machine-readable split between execution and testing tracks.
...
- CLI owns file-oriented commands that read a normalized spec and write generated test artifacts.

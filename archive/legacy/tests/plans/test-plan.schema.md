...
Normalized `test-plan` artifacts should be generated from approved Test Specs before selecting execution tools. Each Test Spec must already bind to one approved Feature Spec version.

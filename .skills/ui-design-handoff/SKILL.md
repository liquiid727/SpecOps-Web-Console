...
description: Translate accepted specs, UI drafts, or Pencil prototypes into screen hierarchy, interaction states, reusable sections, and validation notes for frontend delivery.
---

# UI Design Handoff

Use this skill when SpecOS product-facing frontend work needs a traceable UI design plan before implementation.
